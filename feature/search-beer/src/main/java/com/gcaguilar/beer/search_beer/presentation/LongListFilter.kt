...
import com.gcaguilar.beer.search_beer.domain.FilterItemOption
...
fun LongListFilter(
    searchItem: String,
    itemsToFilterList: List<FilterItemOption>,
